...
public class Position {
    ...
    public Position adjacentSquare(quoridor.Direction d) {
        int newrow = this.row;
        int newcol = this.col;

        if (d == quoridor.Direction.DOWN) newrow++;
        else if (d == quoridor.Direction.UP) newrow--;
        else if (d == quoridor.Direction.LEFT) newcol--;
        else if (d == quoridor.Direction.RIGHT) newcol++;
